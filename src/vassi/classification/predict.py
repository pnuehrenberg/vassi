...
#     sampleable: AnnotatedMixin,
# ) -> tuple[tuple[str, ...], str, EncodingFunction]:
#     return (
...
#     if isinstance(sampleable, AnnotatedMixin):
#         _categories, _background_category, _encoding_function = (
#             _extract_category_metadata(sampleable)
#         )
...
#         raise ValueError(
#             "categories, background_category, and encoding_function must be provided for non-annotated sampleables"
#         )
#     classes_ = getattr(classifier, "classes_", None)
#     assert classes_ is not None and len(categories) == len(classes_), (
#         "The number of categories must match the number of classes in the fitted classifier."
#     )
